...
import { Sparkles, MessageCircle, Phone, ArrowRight, ShieldCheck, Droplet, Award, Zap, CheckCircle2 } from 'lucide-react';
...
export const Hero: React.FC<HeroProps> = ({ onBookNow, onExploreCustomizer, onExploreServices }) => {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-cyan-100/80 border border-cyan-200/80 text-cyan-900 text-xs sm:text-sm font-semibold shadow-xs">
              ...
              <span>Indore’s Premier Custom Bottled Water Plant • Dewas Naka</span>
            </div>
            ...
            <div className="space-y-4">
              ...
              {/* Exact Requested Message Subtitle */}
            ...
            {/* Action Buttons: Book Your Order, WhatsApp Us, Call Now */}
            ...
            <div className="pt-6 border-t border-slate-200/80 grid grid-cols-2 sm:grid-cols-4 gap-4 text-left">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-900">FSSAI Certified</h4>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-900">Waterproof HD</h4>
                  <p className="text-[11px] text-slate-500">Ice-Bucket Proof</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500">Dewas Naka Plant</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-900">Low 100 MOQ</h4>
                  <p className="text-[11px] text-slate-500">Free Design Proof</p>
                </div>
              </div>
            </div>
          </div>

          {/* Right Column: Visual Interactive Bottle Presentation */}
            ...
            <div className="relative mx-auto max-w-md bg-white rounded-3xl p-6 shadow-2xl border border-slate-200/90 shadow-cyan-900/10">
              ...
              <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold text-slate-600 ml-1">Live Bottle Preview</span>
                </div>
              ...
              {/* Realistic Bottle Graphic Representation */}
              <div className="my-6 relative py-4 flex flex-col items-center justify-center min-h-[300px] bg-gradient-to-b from-slate-50 to-cyan-50/50 rounded-2xl border border-dashed border-cyan-200">
                ...
                {/* Main Bottle Body with Custom Label Area */}
                <div className="w-32 h-44 bg-gradient-to-r from-cyan-100/80 via-white/95 to-cyan-100/80 border-x border-cyan-300/40 relative flex items-center justify-center shadow-inner overflow-hidden">
                  ...
                  <div className="w-full py-3 px-2 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-white shadow-lg border-y-2 border-amber-400/80 text-center relative">
                    <div className="absolute top-0.5 right-1 text-[8px] text-amber-300 font-mono">250ml</div>
                    ...
                    <div className="text-[9px] text-slate-300 mt-0.5">24.11.2026 • Sayaji Indore</div>
                    <div className="mt-1 flex items-center justify-center gap-1 text-[8px] text-cyan-300 font-semibold">
                      <Sparkles className="w-2.5 h-2.5" /> BROS WATER
                    </div>
                  </div>
                </div>
                ...
                {/* Floating Floating Badges around Bottle */}
                <div className="absolute -left-3 top-8 bg-white/95 backdrop-blur-xs p-2.5 rounded-xl shadow-lg border border-slate-100 text-left">
                  <p className="text-[10px] font-bold text-slate-500 uppercase">Cap Options</p>
                  <p className="text-xs font-extrabold text-slate-900">Gold • Black • Blue</p>
                </div>
                ...
                <div className="absolute -right-3 bottom-12 bg-white/95 backdrop-blur-xs p-2.5 rounded-xl shadow-lg border border-slate-100 text-left">
                  <p className="text-[10px] font-bold text-slate-500 uppercase">Local Delivery</p>
                  <p className="text-xs font-extrabold text-emerald-600">Free at Dewas Naka</p>
                </div>
              </div>
              ...
              <div className="space-y-3 pt-2">
                ...
                <div className="flex items-center justify-between text-xs text-slate-500 px-1">
                  <span className="flex items-center gap-1">
                    <CheckCircle2 className="w-3.5 h-3.5 text-emerald-500" /> 100% Leak Proof
                  </span>
                  <span className="flex items-center gap-1">
                    <CheckCircle2 className="w-3.5 h-3.5 text-emerald-500" /> Recyclable PET
                  </span>
                  <span className="flex items-center gap-1">
                    <CheckCircle2 className="w-3.5 h-3.5 text-emerald-500" /> Fast Proofs
                  </span>
                </div>
              </div>
            </div>
